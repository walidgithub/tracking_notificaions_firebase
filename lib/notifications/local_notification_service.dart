...
class LocalNotificationService {
  ...
  // we used stream to listen to notification in another screen to let us navigate to the screen of details
  // we need to use context in navigation so we will listen in a StatefulWidget
  // we can listen to another thing not NotificationResponse like a model with specific data
